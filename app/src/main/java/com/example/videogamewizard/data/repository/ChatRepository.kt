package com.example.videogamewizard.data.repository

import com.example.videogamewizard.data.model.ChatAuthor
import com.example.videogamewizard.data.model.ChatMessage
import com.example.videogamewizard.data.network.ChatRequest
import com.example.videogamewizard.data.network.ChatResponse
import com.example.videogamewizard.data.network.HistoryMessage
import com.example.videogamewizard.data.network.RagApi
import com.example.videogamewizard.data.network.RetrofitClient
import kotlinx.coroutines.CancellationException

class ChatRepository(private val api: RagApi = RetrofitClient.ragApi) {
